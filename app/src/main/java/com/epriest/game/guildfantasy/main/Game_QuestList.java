...
public class Game_QuestList extends Game {
...
//    public int selectQuestId = 0;
    ...
    public final int textLimit = 20;
    public final int textLineLimit = 4;

    public Bitmap bg;
    public Bitmap questcard;
    public ArrayList<Bitmap> questBitmapList = new ArrayList<>();

    public Game_QuestList(Game_Main gameMain) {
...
//            }
        ...
        for (int i = 0; i < gameMain.userEnty.QUESTLIST.size(); i++) {
            ...
            questBitmapList.add(GLUtil.loadAssetsBitmap(gameMain.appClass,
...
//                        gameMain.mainButtonAct(INN.GAME_MEMBER, INN.MODE_DEFAULT);
                        ...
                        gameMain.mainButtonAct(INN.GAME_QUEST, enty.id);
                    }
                }
                return;
            } else {
